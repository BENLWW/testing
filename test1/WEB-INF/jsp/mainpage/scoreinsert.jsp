...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/test1 Maven Webapp/src/main/webapp/WEB-INF/jsp/mainpage/scoreinsert.jsp">

	<div class="place" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/test1 Maven Webapp/src/main/webapp/WEB-INF/jsp/mainpage/scoreinsert.jsp">
    <span>位置：</span>
    <ul class="placeul">
    ...
    <form  action="insertdeal" method="post">
	    <table>
	    	...
	    	<tr>
	    		...
	    		<th>    
	    		<div class="vocation">
			    <select class="select3" name="sGrade">
	    	...
	    	<tr>
	    	<td><label>评&nbsp;&nbsp;语：</label></td>
	    	<th colspan="8"><input name="Descript" style="width:80%" type="text" class="scinput" /></th>
	    	<td></td></tr>
	    	<tr><c:if test="${pm.inputting=='Y'}">
	    		<td colspan="9"><span><input name="" type="submit" class="scbtn" value="新增"/></span></td></c:if></tr>
