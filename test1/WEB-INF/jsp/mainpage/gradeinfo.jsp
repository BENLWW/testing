...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/test1 Maven Webapp/src/main/webapp/WEB-INF/jsp/mainpage/gradeinfo.jsp">

	<div class="place" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/test1 Maven Webapp/src/main/webapp/WEB-INF/jsp/mainpage/gradeinfo.jsp">
    <span>位置：</span>
    <ul class="placeul">
...
<%--     <div class="tools">
    ...
    <table class="tablelist">
		...
		<tr>
		 ...
		 <td align = "center"><a href="<%=path%>/mainpage/classinfo?id=${gradeExtensions.grade.gradeId}">${gradeExtensions.grade.gradeName}</a></td>  
